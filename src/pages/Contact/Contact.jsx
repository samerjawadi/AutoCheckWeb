...
export default function Contact() {
  ...
  return (
    <div className="page-enter flex items-center justify-center min-h-screen bg-neutral-950 px-6">
      ...
      >
        <h1 className="text-3xl font-bold text-yellow-400">{t("contact_title")}</h1>

        <div className="flex flex-col gap-1">
          <label className="text-sm text-neutral-400" htmlFor="name">{t("contact_name")}</label>
          <input id="name" name="name" type="text" required value={form.name} onChange={handleChange}
            className="bg-neutral-800 border border-neutral-700 rounded-lg px-4 py-2.5 text-neutral-100 placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-yellow-400"
        ...
        <div className="flex flex-col gap-1">
          ...
          <textarea id="message" name="message" required rows={4} value={form.message} onChange={handleChange}
            className="bg-neutral-800 border border-neutral-700 rounded-lg px-4 py-2.5 text-neutral-100 placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-yellow-400 resize-none"
            placeholder={t("contact_msg_ph")} />
        </div>

        <button type="submit"
          className="bg-yellow-600 hover:bg-yellow-500 text-white font-medium py-2.5 rounded-lg transition-colors">
          {t("contact_send")}
        </button>
      </form>
    </div>
