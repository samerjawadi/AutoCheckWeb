  ...
  return (
    <div className="page-enter p-6 max-w-5xl">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-neutral-100">Cars</h1>
      ...
      <input
        type="text"
        placeholder="Search by plate, VIN, manufacturer or owner..."
        value={search}
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            ...
            {filtered.map((car) => (
              ...
              >
                <td className="px-4 py-3 text-neutral-100 font-medium font-mono">
                  {car.plate}
                </td>
      ...
      {(modal === "add" || modal === "edit") && (
        <Modal
          title={modal === "add" ? "Add Car" : "Edit Car"}
          onClose={close}
        >
          {customers.length === 0 ? (
            <p className="text-neutral-400 text-sm">
              No customers found. Please add a customer first before adding a car.
            </p>
          ) : (
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div>
                <label className={labelCls} htmlFor="customerId">Owner *</label>
                <select
                  id="customerId"
                  name="customerId"
                  required
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className={labelCls} htmlFor="manufacturer">Constructor *</label>
                  <input
                    id="manufacturer"
                    name="manufacturer"
                    required
      ...
      {modal === "delete" && deleteTarget && (
        <Modal title="Delete Car" onClose={close}>
          <p className="text-neutral-300 text-sm">
            Are you sure you want to delete the car with plate{" "}
