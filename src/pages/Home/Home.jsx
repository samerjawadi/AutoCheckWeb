  ...
  return (
    <div className="page-enter p-6 max-w-6xl">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-bold text-neutral-100">
            ...
            <span className="text-neutral-500 font-normal text-xl ml-3">Dashboard</span>
          </h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <StatCard icon={HiUsers}         label="Customers"    value={customers.length}   color="bg-violet-500/10 text-violet-400" />
        <StatCard icon={TbCar}           label="Cars"         value={cars.length}        color="bg-blue-500/10 text-blue-400" />
        <StatCard icon={TbTool}          label="Jobs"         value={scoped.length}      sub={period === "All" ? `${todayCount} today` : undefined} color="bg-orange-500/10 text-orange-400" />
        <StatCard icon={TbBuildingStore} label="Suppliers"    value={suppliers.length}   color="bg-emerald-500/10 text-emerald-400" />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-8">
        ...
        <div className="lg:col-span-2 bg-neutral-900 border border-neutral-800 rounded-xl p-5">
          <h2 className="text-sm font-semibold text-neutral-400 uppercase tracking-widest mb-4">Job Status</h2>
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-5 flex flex-col gap-4">
          <h2 className="text-sm font-semibold text-neutral-400 uppercase tracking-widest">Revenue</h2>
          <div className="flex flex-col gap-3">
            <div className="bg-green-500/5 border border-green-500/20 rounded-xl px-4 py-3">
              <p className="text-xs text-neutral-500 mb-0.5">Collected (Done)</p>
            ...
            <div className="bg-orange-500/5 border border-orange-500/20 rounded-xl px-4 py-3">
              <p className="text-xs text-neutral-500 mb-0.5">Open (Pending + In Progress)</p>
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
        <div className="flex items-center justify-between px-5 py-4 border-b border-neutral-800">
          <h2 className="text-sm font-semibold text-neutral-400 uppercase tracking-widest">
            {period === "All" ? "Recent Jobs" : `Jobs — ${period}`}
          </h2>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-neutral-800 text-neutral-500 text-left text-xs uppercase tracking-wider">
              ...
              <th className="px-5 py-3 font-medium">Date In</th>
          ...
          <tbody>
            ...
            {recent.length === 0 && (
              <tr><td colSpan={5} className="px-5 py-8 text-center text-neutral-600">No jobs for this period.</td></tr>
            )}
          </tbody>
        </table>
      </div>
